...
/*
 * This plugin serves as an inteface to the GeoLocation Service.   
 *
 */
...
public class CordovaLocationServices extends CordovaPlugin implements
	...
	public void onConnected(Bundle bundle) {
		Log.d(Constants.TAG, "Location Services connected");
	...
	public boolean execute(final String action, final JSONArray args,
		...
		final long interval = args.optLong(3, Constants.UPDATE_INTERVAL_IN_MILLISECONDS);
		final long fastInterval = args.optLong(4, Constants.FAST_INTERVAL_CEILING_IN_MILLISECONDS);
